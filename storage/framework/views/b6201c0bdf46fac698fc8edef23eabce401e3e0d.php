...
<!-- Cropper css -->
<link href="<?php echo e(asset('theme/plugins/cropperjs/cropper.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(asset('theme/plugins/cropperjs/main.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopSection(); ?> 
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="img-container">
                      <img src="theme/images/general/image-crop.jpg" id="image" class="cropper-hidden" alt="Picture">
                    </div>
                </div>
            </div>
            <div class="card m-b-30">
...
<!-- Cropper js -->
<script src="<?php echo e(asset('theme/plugins/cropperjs/cropper.js')); ?>"></script>
<script src="<?php echo e(asset('theme/plugins/cropperjs/main.js')); ?>"></script>
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/light-vertical/resources/views/advanced-ui-kits-image-crop.blade.php ENDPATH**/ ?>