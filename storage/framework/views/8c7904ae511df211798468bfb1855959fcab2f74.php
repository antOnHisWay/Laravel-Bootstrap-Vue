...
<!-- Apex css -->
<link href="<?php echo e(asset('theme/plugins/apexcharts/apexcharts.css')); ?>" rel="stylesheet" type="text/css" />
<!-- Slick css -->
<link href="<?php echo e(asset('theme/plugins/slick/slick.css')); ?>" rel="stylesheet" type="text/css" />
<link href="<?php echo e(asset('theme/plugins/slick/slick-theme.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopSection(); ?> 
                            ...
                            <div class="avatar-group">
                                <div class="avatar">
                                    <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                        <img src="theme/images/users/men.svg" alt="avatar" class="rounded-circle">
                                    </a>
                                </div>
                                <div class="avatar">
                                    <a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Amy Adams">
                                        <img src="theme/images/users/women.svg" alt="avatar" class="rounded-circle">
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card-body text-center">
                            <div class="user-slider">
                                <div class="user-slider-item">
                                    <img src="theme/images/users/men.svg" alt="avatar" class="rounded-circle mt-3 mb-4">
                                    <h5>James Smith</h5>
                                    <p>Senior Sales Executive</p>
                                    <p>55 Avenue, North Street Road, Carolina State, New York City, USA</p>
                                </div>
                                <div class="user-slider-item">
                                    <img src="theme/images/users/women.svg" alt="avatar" class="rounded-circle mt-3 mb-4">
                                    <h5>James Smith</h5>
                                    <p>Senior Sales Executive</p>
                                    <p>55 Avenue, North Street Road, Carolina State, New York City, USA</p>
                                </div>
                                <div class="user-slider-item">
                                    <img src="theme/images/users/girl.svg" alt="avatar" class="rounded-circle mt-3 mb-4">
                                    <h5>James Smith</h5>
                                    <p>Senior Sales Executive</p>
                                    <p>55 Avenue, North Street Road, Carolina State, New York City, USA</p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img src="theme/images/users/men.svg" class="img-fluid" width="35" alt="customer"></td>
                                            <td>John Doe</td>
                                        ...
                                        <tr>
                                            <td><img src="theme/images/users/women.svg" class="img-fluid" width="35" alt="customer"></td>
                                            <td>Daniel Chris</td>
                                            <td>demo@example.com</td>
                                            <td>93%</td>
                                            <td>1300</td>
                                        ...
                                        <tr>
                                            <td><img src="theme/images/users/boy.svg" class="img-fluid" width="35" alt="customer"></td>
                                            <td>John Joshua</td>
                                            <td>demo@example.com</td>
                                            <td>87%</td>
                                            <td>1250</td>
...
<!-- Apex js -->
<script src="<?php echo e(asset('theme/plugins/apexcharts/apexcharts.min.js')); ?>"></script>
<script src="<?php echo e(asset('theme/plugins/apexcharts/irregular-data-series.js')); ?>"></script>
<!-- Slick js -->
<script src="<?php echo e(asset('theme/plugins/slick/slick.min.js')); ?>"></script>
<!-- Custom Dashboard js -->  
<script src="<?php echo e(asset('theme/js/custom/custom-dashboard.js')); ?>"></script>
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/light-vertical/resources/views/index.blade.php ENDPATH**/ ?>